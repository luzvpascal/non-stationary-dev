...
for (index_case_study in seq_along(CASE_STUDIES)){
  ...
  # write_hmMDP_uncertain_nonstat_rewards(TR_FUNCTION=list(transition_function_P1(1),#failure
  #                                                        transition_function_P1(1)),
  #                                       outputs$TR_FUNCTION_REW,
  #                                       outputs$TR_FUNCTION_TIMES,
  #                                       outputs$B_FULL,
  #                                       outputs$B_FULL_REW,
  #                                       outputs$B_FULL_TIMES,
  #                                       outputs$B_PAR,
  #                                       outputs$B_PAR_REW,
  #                                       outputs$REW,
  #                                       GAMMA=gamma,
  ...
  plot <- df %>%
    ...
    geom_text(
      data = results_now,
      aes(x = start_time + Tmax, y = -0.25, label = Tmax),
      inherit.aes = FALSE,
      # size=2,
      hjust = 0,
      col = "black"
